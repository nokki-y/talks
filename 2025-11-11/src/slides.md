...
ボランティアと聞くと、自身の労力をただ提供すると考える人もいるかもしれませんがそこから得られることもあります。
...
<!--
流れとしては、はじめに、コミュニティに参加する前の、少しネガティブな話から入ります。
...
実は、僕は新卒では営業をしていました。
で、たまたま書店で手に取ったPythonの本を買って、コードを書いたらそれが楽しくてエンジニアになった人間なので、技術が好きです。
...
<!--
まず、エンジニアをしていると、あれこれ試したいと思っても、コストや納期に悩むのがあるあるです。

前提として、弊社は社名にモチベーションが入っているくらいなので、
エンジニアのモチベーションをとても大事にして、先行的な投資を惜しまない企業体質です。

それでも経験が長くなると、このような壁にぶつかってしまうこともあります。
実際に僕は自身の未熟さもあり、3年前くらいの時期は、そういう経験が続いていた時期です。

そう言ったビジネスとの葛藤を抱えている時期に、v-tokyoに参加しました。
-->
...
<!--
23年のv-tokyo #16です。
ですが、書いてある通り打算的な目的で参加しました。

参加の目的は、開発組織の認知拡大です。

なので当時のX投稿をみるとイベント中に大量に投稿していました。

もちろん、素直な感想を投稿したものも多々ありますが、認知拡大のために存在感を出すために投稿していた記憶がおぼろげにあります。

とても打算的だったな、と恥ずかしい思いです。
-->
...
<!--
前提として、技術を手段として割り切ることが悪いと言いたいわけではないです。

ただ、先程も話した通り技術が好きな僕にとって、当時のこういった状況は結構きつかったです。

ただ、このとき唯一幸運だったのが、存在感を出すという業務的な使命があったがゆえに、この時のv-tokyoは懇親会がなかったのですが、自らスタッフに声をかけ、23年のコアスタッフに参加することができました。

それがたぶん今もここに立っていないので、本当に良かったです。

ただ、開発することがあまり楽しくない時期だったことは事実です。
-->
...
<!--
ここからは、そのような状況から3つの出会いを通じて得た僕の変化感です。
-->
...
技術を手段だと考えているときは、業務で必要な観点でのみ技術を考える傾向が強かったです。

要件として必要なことを満たす、という観点でのみライブラリを見ていました。
-->
...
<!--
これはとても貴重な経験だと考えていて、使い手だけではなく、作り手の考えや悩み、我々が知らないことを知ることで、知っていると思っていた技術の知らない側面に出会うことができました。

僕にとってこれはとても、楽しいことでした。
-->
...
手前味噌ながら、フロント領域の外部に認知拡大に動く役割を担うくらいなので、フロント領域の開発に関しては、少し、天狗になっていました。
-->
...
<!--
しかし、先程話したコアメンバーはもちろん、年下でも自分よりも圧倒的に優秀な人に多数出会い、完全に天狗の鼻は折られました。

ただ、それが苦しかったと言うよりも、むしろ
-->
...
というのも、社内で自身が専門とする領域で可能性が見出しづらい時期だったので、そこにまだ見ぬ自身の伸びしろを見つけられたことにシンプルにワクワクしました。
...
この文脈で言う新しい自分とは、初心を思い出した自分です。

純粋に技術が好きでエンジニアになった頃の自分を思い出す、そんなきっかけになりました。
...
葛藤して楽しくない時期を経て、再び技術を楽しめるようになりました。
ただ、当たり前ですが、時間は戻りません。
...
<div flex justify-start items-center relative pt-3>
  ...
  <div rotate-90 absolute h-10 w-8 class="top-[39px] right-[-22.5px]">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path fill="white" d="M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z"/></svg>
  </div>
</div>
...
<!--
今は葛藤した経験とコミュニティのおかげで思い出した初心を持って、再び純粋に技術を楽しむ新しい自分を探している最中です。

この文脈で言う、新しい自分との出会いは、まだ見ぬ未来の自分との出会いです。
-->
...
<!--
まとめると、打算から始まったコミュニティ活動でしたが、
僕はこの技術を中心としたこの空間で、技術のことから他愛もない話まで
3年間、色々な話をしました。

余談ですが、Vueコミュニティのメンバーは話しかけるといつも親切に対応してくれるしみんな忙しいのに、飲みに誘ったら快く来てくれます。
...
<!--
技術への理解が深まり、そして優秀な人達に自身のまだ見ぬ可能性を見つけることができました。

あまり言ってないですけど、実は結構感謝しています。
他のコミュニティに属したことはないですが、Vueコミュニティでないとこの経験は得られなかったかも知れません。
-->
...
年令を重ねると、こういった大きな環境の変化がある機会は限られてくると思います。
...
<!--
今日も今年のスタッフが多数来ているので、懇親会で話しかけてみてください。
-->
