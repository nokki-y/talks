...
<div flex justify-center items-center relative h-80 w-full>
  ...
  <div absolute top-25 left-30 size-30>
...
<div flex justify-center items-center relative h-60 w-full px-2>
  <div flex justify-center items-center relative size-full rounded-md border-2 border-white mx-20>
    ...
    <div absolute top-25 right-6 size-30>
    ...
    <!-- 技術への矢印 私から技術-->
    <div class="absolute top-29.3 left-55 bg-white rotate-200 h-[2px] w-[40px] rounded-full"></div>
    <div class="absolute top-34 left-30 bg-white rotate-170 h-[2px] w-[140px] rounded-full"></div>
    <div class="absolute top-34 left-56 bg-white rotate-140 h-[2px] w-[40px] rounded-full"></div>
    <!-- 技術への矢印 他者から技術-->
    <div class="absolute top-29.3 left-55 bg-white rotate-200 h-[2px] w-[40px] rounded-full"></div>
    <div class="absolute top-34 left-30 bg-white rotate-170 h-[2px] w-[140px] rounded-full"></div>
    <div class="absolute top-34 left-56 bg-white rotate-140 h-[2px] w-[40px] rounded-full"></div>
